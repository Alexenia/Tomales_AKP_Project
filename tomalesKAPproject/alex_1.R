...
#---------------------------------
setwd("C:/Users/aalda/Google Drive/All plots 2018")
...
nlayers(BH1_stack)
BH1_stack<-writeRaster(BH1_stack, filename=""C:/Users/aalda/Google Drive/All plots 2018/BH1_Stack.tif", format="GTiff", overwrite=TRUE)
